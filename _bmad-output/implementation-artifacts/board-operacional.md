...
| 4.8 — Trilha de execuções (read-side) | `assigned` | Writer (Lane 0) — a iniciar | Lane 0 (QA + Security cruzados) | a criar | — | — | — | Spec Kit consolidado: leitura da trilha `AutomationExecution`/`AutomationActionResult` (4.6) + eventos de cadeia (4.7). Preservar contratos/decisões da 4.7. Read-side puro (padrão 2.17/3.6). | P0 |
